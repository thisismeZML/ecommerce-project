...
const ImageList = [
  {
    id: 1,
    image: Image2,
    title: "Up to 50% off on all Women's Clothing",
    description:
...
const HeroSection = () => {
  ...
  return (
    <div className=" relative overflow-hidden min-h-[550px] sm:min-h-[700px] bg-gray-100 flex justify-center items-center">
      {/* Background Pattern */}
        ...
        <Slider {...setting}>
          {ImageList.map(({ id, image, title, description }) => (
            <div>
              <div
                key={id}
                className="grid grid-cols-1 sm:grid-cols-2  sm:gap-4 lg:gap-0"
              >
                ...
                <div className="flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1">
                  ...
                  <div>
                    <button className="border border-secondary py-2 px-4 rounded">
                      Order Now
                    </button>
                  </div>
                </div>
